          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Plataforma exclusiva que conecta alunos talentosos a projetos
                reais, com mentoria direta da equipe técnica da AFRIKNEW e
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                >
                  ...
                  <ArrowRight
                    className={clsx(
                      "w-5 h-5 sm:w-6 sm:h-6 group-hover:translate-x-1 transition"
                    )}
                  />
                </button>
      ...
      <section id="sobre" className="px-4 sm:px-6 lg:px-8 py-20 bg-gray-900/50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Uma iniciativa da AFRIKNEW para formar a próxima geração de
            desenvolvedores através de projetos reais, mentoria direta e
            visibilidade no mercado de trabalho.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article className="group relative bg-gray-900 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <time className="text-gray-400 text-sm">08 Nov 2024</time>
              </div>
            </article>
            ...
            <article className="group relative bg-gray-900 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 leading-tight">
                  O trabalho é de altíssima qualidade e eu consistentemente
                  supero todos os meus...
                </h3>
                <time className="text-gray-400 text-sm">08 Nov 2024</time>
              </div>
            </article>
