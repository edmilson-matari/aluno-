...
export default function SignUp() {
          ...
          <div className="text-center lg:text-left space-y-8 lg:space-y-12">
            ...
            <div className="space-y-6 max-w-lg mx-auto lg:mx-0">
              ...
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
                Desenvolva projetos reais com mentoria da Afriknew e transforme sua carreira.
              </p>
            </div>
          </div>
  ...
  <div className=" rounded-3xl p-6 sm:p-8 lg:p-10">
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
      ...
      {/* Checkbox Termos - Mais compacto */}
      <div className="flex items-center gap-3">
        <input
          type="checkbox"
          {...register('terms')}
          className="w-4 h-4 bg-white/10 border border-gray-600 rounded text-purple-600 focus:ring-purple-600 focus:ring-2"
        />
        <label className="text-xs sm:text-sm text-gray-300 cursor-pointer">
          Eu concordo com{' '}
      ...
      {/* Botão principal - Altura reduzida em mobile */}
      <button
        type="submit"
    ...
    {/* Login social - Mais compacto */}
    <div className="mt-6 pt-6 border-t border-white/10">
      <p className="text-center text-gray-400 text-xs mb-4">Ou registe-se com</p>
