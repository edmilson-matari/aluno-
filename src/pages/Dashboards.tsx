  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 pb-32">
        ...
        <button onClick={() => {navigate('/project/novo')}} className="hidden w-full sm:flex bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase tracking-wider py-6 rounded-3xl shadow-2xl hover:shadow-indigo-500/50 transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 flex items-center justify-center gap-4 text-small">
          <Plus size={32} />
